<template>
  ...
  <EdgeLabelRenderer>
    ...
    >
      ...
      >
        <button 
          class="flex items-center justify-center w-6 h-6 text-[10px] font-bold rounded-full bg-emerald-500 text-white border-2 border-[color:var(--bg-secondary)] shadow-lg hover:scale-110 transition-transform"
        >
          {{ currentOrder }}
        </button>
      </n-dropdown>
